...
<head>
  ...
  <title>Vem Também — Página não encontrada</title>
  ...
  <style>
    ...
    @media (min-width: 992px){
      .hero{ grid-template-columns: .9fr 1.1fr; gap:2rem; }
    }
  ...
  <div class="content-surface">
    ...
    <div class="hero">
      ...
      <div>
        ...
        <p class="muted">A URL que você tentou acessar não existe, foi movida ou está temporariamente indisponível.</p>
